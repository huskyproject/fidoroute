# Instruction to build fidoroute
...
- Put the fidoroute package in the directory where the other packages of fido
  husky reside:
...
dos:
```sh
   d:\husky\fidoroute>make -f makefile.djg
```
...
You're ready. Now you can install software which uses fidoroute.
